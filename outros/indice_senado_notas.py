...
"G1":"Média móvel híbrida de 30 dias da matriz de polling, na data mais recente do estado. "
     "Não é o número de uma pesquisa avulsa.",
"H1":"Distância em pontos para a linha de corte: o 3º colocado, para quem está em 1º ou 2º; "
     "o 2º colocado, para os demais.",
"I1":"Abre a conta: banda, média, posição, distância para a linha de corte, quantas pesquisas "
     "sustentam o número, data da última pesquisa do estado e a margem de erro usada.",
"J1":"Vínculo com uma das duas chapas presidenciais, pelo registro no TSE. Lula, quando o PT "
...
"K1":"Qual fato do registro sustenta a classificação da coluna anterior.",
"L1":"Nome da coligação estadual e os partidos que a compõem, como registrado no DivulgaCand.",
"M1":"Candidato a governador que disputa pela mesma coligação estadual. Vazio quando a coligação "
     "do Senado não tem candidatura ao governo.",
"N1":"Camada separada da chapa: declaração nominal de apoio. Três fontes, nesta ordem. "
...
"O1":"Link da matéria que sustenta o apoio declarado.",
"P1":"Casado com as abas Radar Senado, Radar Câmara e Radar Assembleias desta planilha.",
"Q1":"Situação do registro no DivulgaCand na data da atualização. Aguardando julgamento é o "
     "estado normal de boa parte dos registros neste momento do calendário.",
"R1":"Pesquisas distintas dos últimos 90 dias que mediram este nome. Com uma só, a banda é provisória.",
"S1":"Data de campo da pesquisa mais recente do estado que entrou na média móvel.",
}
ws.update_notes(N)
